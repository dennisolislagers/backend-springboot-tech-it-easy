...
//  Door de annotatie entity te gebruiken wordt er automatisch een entiteit (tabellen) aangemaakt.
@Entity
public class Television {
//   De volgende annotaties zorgen ervoor dat Java zelf een id aan een televisie toewijst en we maken een primaire key aan.
    @Id
    @GeneratedValue
    private Long id;
...
//  De constructors zijn niet noodzakelijk om aan te maken
//    We maken de default constructor aan
    public Television() {
    }
